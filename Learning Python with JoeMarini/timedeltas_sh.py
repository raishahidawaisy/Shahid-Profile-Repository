...
# construct a basic timedelta (span of time) and print it
...
print("One year from now it was: " + str(now - timedelta(days=365)))
...
print("Its just ", time_to_afd.days, "untill April Fool's day")
